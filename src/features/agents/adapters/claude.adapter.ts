...
export const claudeAdapter: AgentAdapter = createAdapter(claudeDefinition, {
  ...
  getSidebarSections: (): SidebarSection[] => [
    ...
    { id: 'commands', label: 'Commands', icon: 'square-slash', route: '/commands' },
    ...
    { id: 'permissions', label: 'Permissions', icon: 'shield', route: '/permissions' },
    { id: 'model-env', label: 'Model & Env', icon: 'sliders', route: '/model-env' },
    { id: 'settings-file', label: 'Settings (raw)', icon: 'braces', route: '/settings-file' },
  ],
})
